...
export class ReportsController {
    ...
    /**
     * Récupérer la progression historique d'un joueur
     */
    @Get('players/:playerId/progression')
    getPlayerProgression(@Param('playerId') playerId: string) {
        return this.reportsService.getPlayerProgression(playerId);
    }
}
